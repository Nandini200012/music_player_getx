...
class PrivacyPolicy extends StatelessWidget {
  ...
  final String message5 =
      "Nandini built the Saptak Music app as a Free app. This SERVICE is provided by Nandini N at no cost and is intended for use as is.";

  final String message6 =
      "If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at nandhininatarajan04@gmail.com.";
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  PrivacyPolicyTitleAndContent(title: 'Information We Collect:', message: message1),
                  PrivacyPolicyTitleAndContent(title: 'Use of Information:', message: message2),
                  PrivacyPolicyTitleAndContent(title: 'Sharing of Information:', message: message3),
                  PrivacyPolicyTitleAndContent(title: 'Updates to Privacy Policy:', message: message4),
                  Padding(
                    padding: EdgeInsets.all(width1 * 0.03),
                    child: Text(
                      message5,
